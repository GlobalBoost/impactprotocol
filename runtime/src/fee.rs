...
//
// impact is free software: you can redistribute it and/or modify
...
use impact_primitives::currency::CENTS;
...
impl WeightToFeePolynomial for WeightToFee {
	...
	fn polynomial() -> WeightToFeeCoefficients<Self::Balance> {
		// in Impact Protocol, extrinsic base weight (smallest non-zero weight) is mapped to 1/10 CENT:
		let p = CENTS;
...
mod tests {
	...
	use impact_primitives::{CENTS, DOLLARS};

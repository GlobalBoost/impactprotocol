...
Impact Protocol is a next-generation blockchain 🚀.
...
Please do report bugs and [issues here](https://github.com/GlobalBoost/substrate/issues) for anything you suspect requires action in the source. 

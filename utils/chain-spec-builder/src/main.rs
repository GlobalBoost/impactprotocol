...
use impact_cli::chain_spec::{self, AccountId};
...
fn main() -> Result<(), String> {
	...
	let initial_difficulty:U256 = U256::from(200);
	
	let json =
		generate_chain_spec(initial_difficulty, authority_seeds, nominator_accounts, endowed_accounts, sudo_account)?;

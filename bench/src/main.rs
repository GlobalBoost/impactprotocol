...
use impact_testing::bench::{BlockType, DatabaseType as BenchDataBaseType, KeyTypes, Profile};
...
#[derive(Debug, Parser)]
#[command(name = "impact-bench", about = "Impact Protocol integration benchmarks")]
struct Opt {
